        ...
        <div class="container-fluid h-custom">
          <div class="row d-flex justify-content-center align-items-center h-100 form-div ">
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 login-div fbg">
              <form class="form-floating mb-3 fbg">
                
               <h2>Forgot Password</h2>
               <div class="form-outline mb-4 form-floating mb-3  ">
                <input type="email" id="form3Example3" class="form-control form-control-lg  "
                  placeholder="Enter a valid email address" />
                <label class="form-label br" for="form3Example3">Email address</label>
                <div id="emailHelp" class="form-text" style="color:rgba(231, 6, 63, 0.781)">We'll never share your email with anyone else.</div>
              </div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="form-check mb-0">
                    <input class="form-check-input me-2 br" type="checkbox" value="" id="form2Example3" />
