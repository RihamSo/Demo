...
include($_SERVER["DOCUMENT_ROOT"].'/projects/srs-b4-Intern-2/Apartment_Management_Sys/protected/header.php');
 ...
 <div class="container-fluid">
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 "style="background: #c49ee9;">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="./user/chairpersonApartmentUserList.php?aptId=<?php echo $result['aptId']?>" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-people"></i> <span class="ms-1 d-none d-sm-inline"style="color: black;">Apartment Member Management</span> </a>
                    </li>
                    <li>
                        <a href="./notes/chairpersonAptNoteAdd.php?aptId=<?php echo $result['aptId']?>" class="nav-link px-0 align-middle">
        ...
        <div class="col py-3">
            <h3>HI..ChairPerson<?php  echo $result['firstName']." ".$result['lastName'] ;?></h3>
